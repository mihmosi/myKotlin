(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof kotlin === 'undefined') {
      throw new Error("Error loading module 'myKotlin'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'myKotlin'.");
    }if (typeof this['kotlin-wrappers-kotlin-react-dom-js-legacy'] === 'undefined') {
      throw new Error("Error loading module 'myKotlin'. Its dependency 'kotlin-wrappers-kotlin-react-dom-js-legacy' was not found. Please, check whether 'kotlin-wrappers-kotlin-react-dom-js-legacy' is loaded prior to 'myKotlin'.");
    }if (typeof this['kotlinx-html-js'] === 'undefined') {
      throw new Error("Error loading module 'myKotlin'. Its dependency 'kotlinx-html-js' was not found. Please, check whether 'kotlinx-html-js' is loaded prior to 'myKotlin'.");
    }if (typeof this['kotlin-wrappers-kotlin-react-js-legacy'] === 'undefined') {
      throw new Error("Error loading module 'myKotlin'. Its dependency 'kotlin-wrappers-kotlin-react-js-legacy' was not found. Please, check whether 'kotlin-wrappers-kotlin-react-js-legacy' is loaded prior to 'myKotlin'.");
    }root.myKotlin = factory(typeof myKotlin === 'undefined' ? {} : myKotlin, kotlin, this['kotlin-wrappers-kotlin-react-dom-js-legacy'], this['kotlinx-html-js'], this['kotlin-wrappers-kotlin-react-js-legacy']);
  }
  ...
  _.Welcome = Welcome;
  main();
  Kotlin.defineModule('myKotlin', _);
  return _;
}));

//# sourceMappingURL=myKotlin.js.map
